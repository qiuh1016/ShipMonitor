...
class FunctionViewController: UITableViewController {
    
    let function = ["Display Route", "Controller Info", "Alert Info", "Data Analysis", "Ship Info", "System Update"]
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "shipInfoSegue" {
